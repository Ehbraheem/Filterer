...
public struct RGBAImage {
    ...
    public init?(image: UIImage) {
        ...
        // Redraw image for correct pixel format/Users/chinmaydb/Documents/Codes/IOS Data/IOS Projects/Filterer/Filterer/RGBAImage.swift:66:5: 'CGContextDrawImage' is unavailable: Use draw(_:in:)
        ...
        // CGContextDrawImage(imageContext, CGRect(origin: CGPoint(x: 0,y :0), size: image.size), cgImage)
